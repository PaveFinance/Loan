...
export default function LoanCalculator() {
  ...
  const [consentToContactEmployer, setConsentToContactEmployer] =
    useState(false);
  ...
  const handleRentInput = () => {
    ...
    if (maxBorrow && rentNum <= maxBorrow) {
      ...
      setLoanDetails({
        error: `You can only borrow up to GHS ${maxBorrow.toFixed(2)}`,
      });
    }
  };
  ...
  useEffect(() => {
    if (
      rent &&
      maxBorrow &&
      interestRates[upfront] &&
      periods[paymentSchedule]
    ) {
      calculateLoan();
    }
  ...
  return (
    <div
      id="loan"
      className="p-6 max-w-lg mx-auto   bg-white rounded-xl shadow-lg space-y-6 sm:my-10 "
    >
      {/* Step 1: Salary Input */}
      {step === 1 && (
        <>
          <h2 className="text-xl md:text-2xl lg:text-4xl font-bold text-center text-blue-600">
            Pave Loan Calculator
          </h2>
      ...
      {step === 2 && (
        <>
          ...
          <label
            htmlFor="rent"
            className="block text-lg font-bold text-black text-center"
          >
            Monthly Rent
          </label>
          <input
            ...
            <>
              ...
              {loanDetails && (
                <div className="mt-4 p-4 border rounded bg-gray-100">
                  <p>
                    Upfront Payment: GHS {loanDetails.upfrontPayment.toFixed(2)}
                  </p>
                  <p>
                    Total Repayment (Includes Interest): GHS{" "}
      ...
      {step === 3 && (
        <>
          ...
          {errors.yearsEmployed && (
            <p className="text-red-500">{errors.yearsEmployed}</p>
          )}
          ...
          />
          {errors.hrManagerName && (
            <p className="text-red-500">{errors.hrManagerName}</p>
          )}
          ...
          {errors.hrManagerEmail && (
            <p className="text-red-500">{errors.hrManagerEmail}</p>
          )}
          ...
          />
          {errors.hrManagerPhone && (
            <p className="text-red-500">{errors.hrManagerPhone}</p>
          )}
          ...
          <div className="mt-8">
            <p className="mb-4">
              <input
                ...
                className="mr-3"
              />
              Do you consent to Pave reaching out to your Employer to provide an
              undertaking to guarantee your facility?
            </p>
            <p className="mb-4">
              <input
                type="checkbox"
                ...
                className="mr-3"
              />
              Do you consent to an amount of{" "}
              <span className="font-bold text-green-700">
                GHS {loanDetails?.repaymentAmount?.toFixed(2)}
              </span>{" "}
              to be deducted from your monthly salary?
            </p>
            <p className="mb-4">
              <input
                type="checkbox"
                ...
                className="mr-3"
              />
              By checking this box and writing your name above, you consent with
              PAVE proceeding with your Application.
            </p>
            <p className="mb-4">
              <input
                type="checkbox"
                ...
                className="mr-3"
              />
              By checking this box, you consent to paying any applicable fees to
      ...
      {step === 4 && (
        <>
          <h2 className="text-2xl font-bold text-center text-blue-800 underline">
          ...
          <button
            ...
            className={`w-full p-3 rounded mt-4 ${
              !isFormComplete() ? "bg-gray-500" : "bg-green-700"
            } text-white`}
      ...
      {step === 5 && (
        <>
          ...
          <h3 className="text-lg font-bold text-center text-blue-700 underline decoration-blue-700">
            Applicant Details
          </h3>
          <p>
          ...
          <p>
            <strong>Salary:</strong> GHS {salary}
          </p>
          <h3 className="text-lg font-bold text-center text-blue-700 underline decoration-blue-700 ">
            Payments Summary
          </h3>
          ...
          <p>
            <strong>Upfront Payment:</strong> GHS{" "}
            {loanDetails?.upfrontPayment?.toFixed(2)}
          </p>
          <p>
            <strong>Repayment Amount:</strong> GHS{" "}
            {loanDetails?.repaymentAmount?.toFixed(2)}
          </p>
          ...
          <p>
            <strong>Landlord's Name:</strong> {landlordName}
          </p>
          <p>
            <strong>Landlord's Phone:</strong> {landlordPhone}
          </p>
          <p>
            <strong>Landlord's Email:</strong> {landlordEmail}
          </p>
          <p>
            <strong>Apartment Location:</strong> {apartmentLocation}
          </p>
      ...
      {step === 6 && (
        <>
          <h2 className="text-3xl font-bold text-center text-green-700 underline">
            {" "}
            Huraay! Your Submission is Complete!
          </h2>
          <h2 className="text-lg text-center text-blue-600">
            <p>We are excited to support you in your rental Journey!</p>
            <p>Keep an eye on your inbox</p>
            <p>
              We will email you within{" "}
              <span className="font-semibold text-blue-700 ">3 - 7</span>{" "}
              business days
            </p>
            <p>Got questions ?</p>
            <p>
              ...
              <span className="font-semibold text-blue-700 ">
                <Link href="tel:0207337449">0207337449</Link>
              </span>
            </p>
          </h2>
          <button
